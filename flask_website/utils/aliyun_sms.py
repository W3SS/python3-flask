...
class AliyunSMS(object):
    def __init__(self, app):
        ...
        self.key = 'LTAIp5j2DxU47O42'
        self.secret = 'EY9OdjeinAnEOeDyFNZb2OiT3Xg4ep'
        self.signature = ""
        ...
        self.gateway = 'https://sms.aliyuncs.com/'
        self.action = ""
        self.sign = ""
        self.template = "SMS_111785732"
        self.params = {}
        self.phones = []
    ...
    def send_single(self, phone, sign, template, params):
        ...
        print(self.gateway + "?" + query_string)
